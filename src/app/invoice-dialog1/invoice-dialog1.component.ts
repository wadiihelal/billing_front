...
@Component({
  selector: 'app-invoice-dialog1',
  templateUrl: './invoice-dialog1.component.html',
  styleUrls: ['./invoice-dialog1.component.css']
})
export class InvoiceDialog1Component implements OnInit {
   invoicesCall: any = [];
      event: any;
     res:any=[];
 ...
 this.orderData.invoicesCall().subscribe((tt)=>{  this.invoicesCall=tt;   });
   orderData.ordersCall().subscribe((tt)=>{
     this.ordersCall=tt;
 ...
 this.orderForm = this._formBuilder.group({
  ...
  lastTableEvent: any;
   ...
   orderForm: FormGroup;
   row:any;
   displayedColumns: string[] = ['select','idOrder','clientPoNumber', 'clientId','title','isbn10','qtyRequested','qtyDelivered','Due Date','status','ActionsO'];
